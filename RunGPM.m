function GPMresult = RunGPM(GPMparams,x1,x2,resultGPMfile,...
...
%         applyTime = toc;
    ...
    GPMresult.runtime = runtime;
    GPMresult.usedmem = usedmem.MemUsedMATLAB/1024/1024/1024;
    save(resultGPMfile,'GPMresult');
else
    load(resultGPMfile,'GPMresult');
end
