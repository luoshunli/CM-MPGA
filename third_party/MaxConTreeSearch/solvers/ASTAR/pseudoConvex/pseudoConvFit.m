function [sol, outl, UniqueNodeNumber, hInit, ubInit, levelMax, NODIBP, runtime,usedmem] = pseudoConvFit(A,b,c,d,solInit,th,method,runtimeLimit)
if nargin < 6
    runtimeLimit = -1;
end
tic;
...
elseif strcmp(method, 'A*-NAPA-DIBP')    
     [sol, outl, ~,UniqueNodeNumber,hInit, ubInit, levelMax, ~, NODIBP,usedmem] = ASTARWithH2_DIBP_pseudoV2(A,b,c,d, solInit, th, 1, 0, runtimeLimit);
end
runtime = toc;
end
